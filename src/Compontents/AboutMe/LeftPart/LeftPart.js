...
export default function LeftPart() {
  return (
    <div className='AboutMeLeftPartMainContainer'>
        <TextAnimation phrase={'An enthusiastic student who likes coding lengthy scripts to creatively solve strange problems. When I get free time, I enjoy spending that time designing and creating website. I am really passionate about tech and learning new programming languages and I love to develop new things like some program and websiteFor now, I am practicing web development while also learning flutter to develop mobile applications, with a desire to be a skilled software developer.'}/>
